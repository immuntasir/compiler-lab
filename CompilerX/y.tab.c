...
{
       0,    55,    55,    60,    65,    72,    79,    87,    93,    97,
     106,   117,   129,   139,   150,   161,   164,   167,   170,   173,
     176
};
#endif
...
{
  "$end", "error", "$undefined", "real", "integer", "true", "false", "id",
  "':'", "'='", "';'", "','", "'-'", "'+'", "'*'", "'/'", "'('", "')'",
  "$accept", "assignment", "vars", "exprs", "expr", "sum", "term",
  "factor", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,   260,   261,   262,    58,    61,
      59,    44,    45,    43,    42,    47,    40,    41
};
# endif
...
{
      17,   -17,    25,    -1,   -17,    22,    19,    -3,   -17,   -17,
     -17,   -17,   -17,   -17,    11,    -3,    -5,   -17,    10,    14,
     -17,    14,    15,   -17,    -3,    11,    11,    11,    11,   -17,
     -17,    14,    14,   -17,   -17
};
...
{
       0,     3,     0,     0,     1,     0,     0,     0,     4,    18,
      17,    15,    16,    19,     0,     0,     0,     5,     7,     8,
      12,     9,     0,     2,     0,     0,     0,     0,     0,    20,
       6,    11,    10,    13,    14
};
...
{
       9,    10,    11,    12,    13,    23,    24,     5,    21,    14,
       6,    33,    34,    15,     9,    10,    11,    12,    13,    31,
      32,    22,    25,    26,     1,     4,     8,    15,    27,    28,
      30,     7,    29
};

static const yytype_uint8 yycheck[] =
{
       3,     4,     5,     6,     7,    10,    11,     8,    14,    12,
      11,    27,    28,    16,     3,     4,     5,     6,     7,    25,
      26,    15,    12,    13,     7,     0,     7,    16,    14,    15,
      24,     9,    17
};
...
{
       0,     7,    19,    20,     0,     8,    11,     9,     7,     3,
       4,     5,     6,     7,    12,    16,    21,    22,    23,    24,
      25,    24,    22,    10,    11,    12,    13,    14,    15,    17,
      22,    24,    24,    25,    25
};
...
#line 72 "yacc.y" /* yacc.c:1646  */
    {	
						...
						getName((yyvsp[0].ee).code);
						strcpy(right[rptr],name);
						rptr++;
						(yyval.ee).code = (yyvsp[0].ee).code;
					}
...
#line 167 "yacc.y" /* yacc.c:1646  */
    {				
						sprintf((yyval.ee).str,"%d",(yyvsp[0].i));
					}
...
#line 170 "yacc.y" /* yacc.c:1646  */
    {				
						sprintf((yyval.ee).str,"%f",(yyvsp[0].f));								
					}
